...
public class DriverService {
    ...
    public DriverService(ReactiveDriverRepository driverRepository, DriverMapper driverMapper, ReactiveDriverEventRepository reactiveDriverEventRepository) {
