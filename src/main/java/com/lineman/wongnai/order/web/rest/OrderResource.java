...
public class OrderResource {
    ...
    private final OrderRepository orderRepositoryy;
    
    private final ReactiveDriverRepository driverRepository;

    public OrderResource(OrderService orderService, ReactiveOrderRepository orderRepository, ReactiveDriverRepository driverRepository,
    		ReactiveOrderEventRepository reactiveOrderEventRepository, OrderRepository orderRepositoryy) {
        this.orderService = orderService;
        this.orderRepository = orderRepository;
        this.driverRepository = driverRepository;
        this.reactiveOrderEventRepository = reactiveOrderEventRepository;
        this.orderRepositoryy = orderRepositoryy;
    }
    ...
    /*@GetMapping(value = "/orders/status", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<OrderEvent> getMovies(){
        return this.reactiveOrderEventRepository.findAll()
                .repeatWhen(flux -> flux.delayElements(Duration.ofSeconds(3)))
